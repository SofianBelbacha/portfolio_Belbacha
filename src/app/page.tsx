    ...
    <>
      <section className="header-section flex flex-col items-center justify-center gap-5 h-screen w-full p-10 overflow-hidden relative">
        ...
        <div className="flex items-center justify-center gap-4 relative z-10">
          ...
          {/* Dark Button */}
          <Link href="#solutions" className="flex items-center justify-center gap-2 h-[44px] px-4 bg-zinc-900 hover:bg-[rgb(255,255,255)] text-white hover:text-black text-sm font-semibold border cursor-pointer overflow-hidden relative transition" style={{ "willChange": "transform", "borderRadius": "12px", "borderColor": "rgb(255, 255, 255)" }}>
            Voir Mes Projets
          </Link>
        </div>
      ...
      <div className="max-w-screen-xl w-full flex flex-col lg:flex-row mx-auto items-center justify-between gap-y-14 gap-x-10 px-6 py-12 lg:py-0">
        <div className="max-w-xl">
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center gap-4">
            ...
            <Button variant="outline" size="lg" className="w-full sm:w-auto rounded-full text-base shadow-none cursor-pointer">
